...
namespace YimMenu::Features
{
	namespace KortzCenterHeist
	{
		...
		// State 17: finish primary-target interaction.
		...
		static TakePrimaryTarget _KortzCenterTakePrimary{"kortzcenterheisttakeprimary","Take Primary Target","Starts the primary target interaction"};
		static FinishPrimaryTarget _KortzCenterFinishPrimary{"kortzcenterheistfinishprimary","Finish Primary Target","Finishes the primary target interaction"};
